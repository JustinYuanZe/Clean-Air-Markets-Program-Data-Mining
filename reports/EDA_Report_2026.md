...
This report provides a detailed exploratory analysis of the cleaned and filtered daily emissions dataset containing active rows only for the year 2026. Visual scales are dynamically aligned across all years to support visual comparison.
