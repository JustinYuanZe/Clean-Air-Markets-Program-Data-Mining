...
This report provides a detailed exploratory analysis of the cleaned and filtered daily emissions dataset containing active rows only.
...
![Pearson Correlation Heatmap](plots/correlation_matrix.png)

### B. Emissions Profile by Fuel Type
![Emissions Profile by Fuel Type](plots/emissions_by_fuel.png)

### C. Gross Load vs Heat Input density
![Gross Load vs Heat Input](plots/gross_load_vs_heat_input.png)
